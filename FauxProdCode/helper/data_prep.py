...
def proces_spec_company_files(company_code, df):
   if company_code == '0002':
     df["OriginZip"] = '33602' ## dealing with a conmpany that only sends from one zipcode 

##iterates over a given directory to read in all the files there 
##Establish some heuristic for file naming- say file names are ddmmyyyy_CCCC.csv wgere cccc is some company code 
